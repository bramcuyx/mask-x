...
if NUM_EXAMPLES is None:
    MODEL_PKL = ROOT / "fuss_ml_lgbm_crf_model_all.pkl"
    OUT_CSV = ROOT / "fuss_ml_lgbm_crf_metrics_all.csv"
else:
    MODEL_PKL = ROOT / f"fuss_ml_lgbm_crf_model_seed{SEED}_{NUM_EXAMPLES}.pkl"
    OUT_CSV = ROOT / f"fuss_ml_lgbm_crf_metrics_seed{SEED}_{NUM_EXAMPLES}.csv"
...
def main():
    ...
    TEST_LIST = ROOT / f"fuss_test_files.txt"
    ...
    TEST_LIST = ROOT / "fuss_test_files.txt"
