...
def main():
    ...
    masks_folder = pathlib.Path(config["paths"]["masks_folder"]) / "dl_unet"
    prob_folder = pathlib.Path(config["paths"]["masks_folder"]) / "dl_unet_prob"
    plots_folder = pathlib.Path(config["paths"]["plots_folder"]) / "dl_unet"
