...
if NUM_EXAMPLES is None:
    MODEL_PKL = MODELS_DIR / "fuss_hybrid_dsp_ml_model_all.pkl"
    OUT_CSV = FUSS_RESULTS_DIR / "fuss_hybrid_dsp_ml_metrics_all.csv"
    TEST_LIST = FUSS_OUTPUTS_DIR / "fuss_hybrid_dsp_ml_test_files.txt"
else:
    MODEL_PKL = MODELS_DIR / f"fuss_hybrid_dsp_ml_model_seed{SEED}_{NUM_EXAMPLES}.pkl"
    OUT_CSV = FUSS_RESULTS_DIR / f"fuss_hybrid_dsp_ml_metrics_seed{SEED}_{NUM_EXAMPLES}.csv"
    TEST_LIST = FUSS_OUTPUTS_DIR / f"fuss_hybrid_dsp_ml_test_files_seed{SEED}_{NUM_EXAMPLES}.txt"
