...
def main():
    ...
    masks_folder = marine_outputs_dir / "masks" / "ml_lgbm_crf"
    prob_folder = marine_outputs_dir / "probabilities" / "ml_lgbm_crf"
    raw_prob_folder = marine_outputs_dir / "probabilities" / "ml_lgbm_crf_raw"
    plots_folder = marine_outputs_dir / "plots" / "ml_lgbm_crf"

    if args.model is not None:
        model_path = resolve_path(args.model)
    else:
        model_path = get_config_path(config, "ml_model_bundle")
